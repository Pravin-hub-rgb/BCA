...
// Frame class is heavy weight and JFrame is better user interface you can feel it
class TestFrameWin extends JFrame implements ActionListener {
    FlowLayout fl; // this won't change // the thing which is visible only there we use J
    JFrame f1;
    JLabel lbl_n1, lbl_n2, lbl_ans;
    JTextField txt_n1, txt_n2, txt_ans;
    JButton btn_add, btn_sub, btn_div, btn_mul, btn_reset;

    TestFrameWin() {
        fl = new FlowLayout();
        f1 = new JFrame("Welcome");
        lbl_n1 = new JLabel("Num 1");
        lbl_n2 = new JLabel("Num 2");
        lbl_ans = new JLabel("Ans");
        txt_n1 = new JTextField(20);
        txt_n2 = new JTextField(20);
        txt_ans = new JTextField(20);
        btn_add = new JButton("Add");
        btn_sub = new JButton("Sub");
        btn_div = new JButton("Div");
        btn_mul = new JButton("Mut");
